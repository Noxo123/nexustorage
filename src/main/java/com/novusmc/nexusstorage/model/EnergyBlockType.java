...
/**
 * Les blocs du systeme d'energie Nexus (reseau physique de cables, style RF/FE).
 * Chaque type porte son role dans le graphe (source, stockage, cable, etc.)
 * et ses valeurs de base (surchargeables depuis config.yml).
 */
public enum EnergyBlockType {
    ...
    REDSTONE_REGULATOR(Material.OBSERVER, Role.REGULATOR, "&c&lNexus Regulator",
            "&7Coupe automatiquement les Interfaces", "&7si l'energie stockee passe sous un seuil.",
